...
const TRANSLATED = [
  ...
  'packages/apps/src/archive/menus.ts',
  'packages/apps/src/browser/menus.ts',
  'packages/apps/src/calculator/menus.ts',
  'packages/apps/src/calendar/menus.ts',
  'packages/apps/src/charmap/menus.ts',
  'packages/apps/src/chess/menus.ts',
  'packages/apps/src/clipboard/menus.ts',
  'packages/apps/src/clock/menus.ts',
  'packages/apps/src/colour/menus.ts',
  'packages/apps/src/console/menus.ts',
  'packages/apps/src/contacts/menus.ts',
  'packages/apps/src/editor/menus.ts',
  'packages/apps/src/files/menus.ts',
  'packages/apps/src/mail/menus.ts',
  'packages/apps/src/media/menus.ts',
  'packages/apps/src/minesweeper/menus.ts',
  'packages/apps/src/notes/menus.ts',
  'packages/apps/src/paint/menus.ts',
  'packages/apps/src/photos/menus.ts',
  'packages/apps/src/preview/menus.ts',
  'packages/apps/src/reminders/menus.ts',
  'packages/apps/src/sheets/menus.ts',
  'packages/apps/src/slides/menus.ts',
  'packages/apps/src/software/menus.ts',
  'packages/apps/src/solitaire/menus.ts',
  'packages/apps/src/storage/menus.ts',
  'packages/apps/src/sudoku/menus.ts',
  'packages/apps/src/sysinfo/menus.ts',
  'packages/apps/src/taskmanager/menus.ts',
  'packages/apps/src/twenty48/menus.ts',
  'packages/apps/src/units/menus.ts',
  'packages/apps/src/workbench/menus.ts',
  'packages/apps/src/writer/menus.ts',
  'packages/apps/src/settings/pages/Region.tsx',
  'packages/apps/src/settings/pages/Taskbar.tsx',
  ...
  'packages/apps/src/settings/pages/Notifications.tsx',
  'packages/apps/src/settings/pages/Sound.tsx',
  'packages/apps/src/settings/pages/Network.tsx',
  'packages/apps/src/settings/pages/Power.tsx',
  'packages/apps/src/settings/pages/Privacy.tsx',
  'packages/apps/src/settings/pages/Reset.tsx',
  'packages/apps/src/settings/pages/Cursor.tsx',
  'packages/apps/src/settings/pages/Storage.tsx',
  'packages/apps/src/settings/pages/Store.tsx',
  'packages/apps/src/settings/pages/Wallpaper.tsx',
  'packages/apps/src/settings/pages/Keyboard.tsx',
  'packages/apps/src/settings/pages/Files.tsx',
  'packages/apps/src/settings/pages/About.tsx',
  'packages/apps/src/settings/pages/Profiles.tsx',
  'packages/apps/src/files/CardView.tsx',
  'packages/apps/src/files/ColumnView.tsx',
  'packages/apps/src/files/FilePreview.tsx',
  'packages/apps/src/files/Files.tsx',
  'packages/apps/src/files/FilesSidebar.tsx',
  'packages/apps/src/files/FilesToolbar.tsx',
  'packages/apps/src/files/GridView.tsx',
  'packages/apps/src/files/IndexRail.tsx',
  'packages/apps/src/files/InfoDialog.tsx',
  'packages/apps/src/files/RenameInput.tsx',
  'packages/apps/src/mail/ComposeSheet.tsx',
  'packages/apps/src/mail/Mail.tsx',
  'packages/apps/src/mail/MailboxSidebar.tsx',
  'packages/apps/src/mail/MessageList.tsx',
  'packages/apps/src/mail/ReadingPane.tsx',
  'packages/apps/src/notes/NoteEditor.tsx',
  'packages/apps/src/notes/NoteList.tsx',
  'packages/apps/src/notes/Notes.tsx',
  'packages/apps/src/notes/TagRail.tsx',
  'packages/apps/src/writer/FindBar.tsx',
  'packages/apps/src/writer/Writer.tsx',
  'packages/apps/src/writer/WriterToolbar.tsx',
  'packages/apps/src/sheets/FunctionsDialog.tsx',
  'packages/apps/src/sheets/Grid.tsx',
  'packages/apps/src/sheets/Sheets.tsx',
  'packages/apps/src/slides/BulletList.tsx',
  'packages/apps/src/slides/Inspector.tsx',
  'packages/apps/src/slides/Presenter.tsx',
  'packages/apps/src/slides/SlideCanvas.tsx',
  'packages/apps/src/slides/SlideList.tsx',
  'packages/apps/src/slides/Slides.tsx',
  'packages/apps/src/preview/Filmstrip.tsx',
  'packages/apps/src/preview/Preview.tsx',
  'packages/apps/src/preview/Toolbar.tsx',
  'packages/apps/src/preview/viewers/CsvView.tsx',
  'packages/apps/src/preview/viewers/MediaView.tsx',
  'packages/apps/src/preview/viewers/PdfView.tsx',
  'packages/apps/src/preview/viewers/UnsupportedView.tsx',
  'packages/apps/src/photos/AlbumSidebar.tsx',
  'packages/apps/src/photos/InfoPanel.tsx',
  'packages/apps/src/photos/Lightbox.tsx',
  'packages/apps/src/photos/PhotoGrid.tsx',
  'packages/apps/src/photos/Photos.tsx',
  'packages/apps/src/photos/PhotosToolbar.tsx',
  'packages/apps/src/media/MediaPlayer.tsx',
  'packages/apps/src/media/NowPlaying.tsx',
  'packages/apps/src/media/Playlist.tsx',
  'packages/apps/src/media/SeekBar.tsx',
  'packages/apps/src/media/Transport.tsx',
  'packages/apps/src/terminal/Terminal.tsx',
  'packages/apps/src/calendar/AgendaList.tsx',
  'packages/apps/src/calendar/Calendar.tsx',
  'packages/apps/src/calendar/CalendarSidebar.tsx',
  'packages/apps/src/calendar/EventDialog.tsx',
  'packages/apps/src/calendar/MonthGrid.tsx',
  'packages/apps/src/calendar/TimeGrid.tsx',
  'packages/apps/src/contacts/ContactDetail.tsx',
  'packages/apps/src/contacts/ContactEditor.tsx',
  'packages/apps/src/contacts/ContactList.tsx',
  'packages/apps/src/contacts/Contacts.tsx',
  'packages/apps/src/contacts/DuplicatesDialog.tsx',
  'packages/apps/src/contacts/GroupsSidebar.tsx',
  'packages/apps/src/reminders/ComposeField.tsx',
  'packages/apps/src/reminders/DetailsDialog.tsx',
  'packages/apps/src/reminders/ReminderList.tsx',
  'packages/apps/src/reminders/Reminders.tsx',
  'packages/apps/src/reminders/RemindersSidebar.tsx',
  'packages/apps/src/browser/AddressBar.tsx',
  'packages/apps/src/browser/Browser.tsx',
  'packages/apps/src/browser/FavoritesBar.tsx',
  'packages/apps/src/browser/Frame.tsx',
  'packages/apps/src/browser/NavigationBar.tsx',
  'packages/apps/src/browser/TabStrip.tsx',
  'packages/apps/src/browser/pages/History.tsx',
  'packages/apps/src/browser/pages/Library.tsx',
  'packages/apps/src/browser/pages/Settings.tsx',
  'packages/apps/src/browser/pages/Start.tsx',
  'packages/apps/src/taskmanager/PerformanceTab.tsx',
  'packages/apps/src/taskmanager/ProcessesTab.tsx',
  'packages/apps/src/taskmanager/ServicesTab.tsx',
  'packages/apps/src/taskmanager/TaskManager.tsx',
  'packages/apps/src/console/Console.tsx',
  'packages/apps/src/console/LogList.tsx',
  'packages/apps/src/storage/Folders.tsx',
  'packages/apps/src/storage/LargestFiles.tsx',
  'packages/apps/src/storage/Overview.tsx',
  'packages/apps/src/storage/Storage.tsx',
  'packages/apps/src/sysinfo/StorageBar.tsx',
  'packages/apps/src/sysinfo/SystemInfo.tsx',
