---
name: rust-engineer
description: Owns crates/lumen-kernel and apps/desktop/src-tauri — the sandboxed file system, system information, configuration, and Tauri commands. Use for anything native or Windows-specific.
