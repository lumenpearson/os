---
name: ui-designer
description: Builds and reviews interface components in packages/ui and the shell. Use for any visual work — atoms, molecules, organisms, layout, motion, cursor, theming. Enforces the design rules in CLAUDE.md and the kill-ai-slop taxonomy.
